...
![image.png](./静态链接&动态链接.assets/1617260747319-f008c915-4609-420e-9e8e-0d7dbf4fcaa6.png)

并通过函数在表偏移定位具体函数信息，看到 _fizz 是在 `libbar.dylib` 动态库中，待改写的区域为 `__DATA.__la_symbol_str`

![image.png](./静态链接&动态链接.assets/1617260801883-5195b8e1-ede9-4ee7-95aa-0e865b3b409f.png)
